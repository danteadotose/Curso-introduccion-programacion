...
long arreglo1=0,arreglo2=0,i,cantidad1,cantidad2,numero,unionor,interseccion,difsim,j,vector[32],x,difa1,difa2,respuesta;
do{
arreglo1=0;
arreglo2=0;

//Explica para qué sirve el programa y pide los datos necesarios para funcionar.
printf("Hola, este programa está diseñado para calcular la unión, intersección y diferencais simétricas y asimétricas de dos arreglos con distintos datos.\n");
printf("¿Cuántos números quieres que tenga el arreglo # 1? Máximo 31\n");
scanf("%ld",&cantidad1);
...
printf("Ingresa tus números, estos pueden estar en el rango de 0 a 31.\n");
for (i = 0; i < cantidad1; i++){
	numero=0;
	scanf("%ld", &numero);
	arreglo1=arreglo1|(1<<(numero+1));
}
printf("¿Cuántos números quieres que tenga el arreglo # 2? Máximo 31\n");
scanf("%ld",&cantidad2);
printf("Ingresa tus números, estos pueden estar en el rango de 0 a 31.\n");
